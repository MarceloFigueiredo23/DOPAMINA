...
(function (w) {
  ...
  /* DOPAMINA SHOP — monograma profissional (marketplace premium) */
  var LOGO_DOPAMINA =
    '<svg class="brand-mark brand-mark--dopamina" viewBox="0 0 44 44" width="44" height="44" aria-hidden="true">' +
    '<defs>' +
    '<linearGradient id="dopaSiteGrad" x1="0" y1="0" x2="44" y2="44">' +
    '<stop offset="0%" stop-color="#c084fc"/><stop offset="50%" stop-color="#b026ff"/><stop offset="100%" stop-color="#ff2d95"/>' +
    '</linearGradient>' +
    '<linearGradient id="dopaSiteGradSoft" x1="0" y1="0" x2="0" y2="44">' +
    '<stop offset="0%" stop-color="#1c1c26"/><stop offset="100%" stop-color="#101018"/>' +
    '</linearGradient>' +
    '</defs>' +
    '<rect x="1" y="1" width="42" height="42" rx="11" fill="url(#dopaSiteGradSoft)" stroke="url(#dopaSiteGrad)" stroke-width="1.25"/>' +
    '<path d="M15 13 H24.5 C29.5 13 33 16.2 33 20.5 C33 24.8 29.5 28 24.5 28 H19 V35" fill="none" stroke="url(#dopaSiteGrad)" stroke-width="3.2" stroke-linecap="round" stroke-linejoin="round"/>' +
    '<circle cx="31" cy="13" r="2.25" fill="#00ffa3"/>' +
    '<path d="M11 35 H33" stroke="url(#dopaSiteGrad)" stroke-width="1" stroke-linecap="round" opacity="0.35"/>' +
    '</svg>';
