...
(function (w) {
  ...
  var premium = [
    ...
    { id: 'p06', brand: 'Samsung', name: 'Smart TV 55" Crystal UHD 4K CU8000',     shop: 'Mercadopamina', price: 2499, oldPrice: 2999, tag: 'TV', image: ecImg('photo-1593359677879-a670071ebdbe'), rating: 4.7, reviews: 2890, prime: true, specs: ['Painel 55" 4K UHD 3840×2160', 'HDR10+ · HLG · Motion Xcelerator', 'Sistema Tizen · apps Netflix, Prime, Disney+', '3 HDMI · 1 USB · Wi-Fi · Bluetooth', 'Controle remoto por voz Bixby'], desc: 'Smart TV Samsung Crystal UHD 55" com imagem 4K, HDR e acesso aos principais apps de streaming.' },
    ...
    { id: 'p13', brand: 'Lenovo', name: 'PC Gamer Ryzen 5 + RTX 4060 16GB',     shop: 'Mercadopamina', price: 5999, oldPrice: 6999, tag: 'Gamer', image: ecImg('photo-1593305841991-05c297ba4575'), rating: 4.7, reviews: 534, prime: true, specs: ['GPU NVIDIA GeForce RTX 4060 8GB GDDR6', 'AMD Ryzen 5 7600 · 6 núcleos / 12 threads', '16GB DDR5 5200MHz · SSD NVMe 512GB', 'Fonte 650W 80 Plus · Windows 11 Home', 'Ideal para 1080p/1440p em alta taxa de quadros'], desc: 'Desktop gamer Lenovo com placa RTX 4060 e Ryzen 5 — roda os lançamentos em alta qualidade com ray tracing.' },
    ...
    { id: 'p16', brand: 'Sony', name: 'WH-1000XM5 — Preto',     shop: 'Mercadopamina', price: 1899, oldPrice: 2299, tag: 'Áudio', image: ecImg('photo-1505740420928-5e560c06d30e'), rating: 4.8, reviews: 5678, prime: true, specs: ['Cancelamento de ruído líder (ANC) adaptativo', 'Drivers de 30mm · áudio Hi-Res LDAC', 'Até 30h de bateria · carga rápida 3 min = 3h', 'Multipoint · 2 dispositivos simultâneos', 'Dobrável · estojo rígido incluso'], desc: 'Headphone over-ear Sony WH-1000XM5 com o melhor cancelamento de ruído da categoria e som premium para viagens e home office.' },
